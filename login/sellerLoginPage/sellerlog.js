function sellerlogin(){
    const emailad = document.querySelector('#inputFName2').value;
    const adderrror1=document.getElementById("selerror1")
    ...
    if(  emailmatch){
        ...
        adderrror1.innerHTML="Email is require"
    }else{
    ...
    var pw = document.getElementById("inputLName2").value; 
    const adderrror2= document.getElementById("selerror2"); 
